...
export class HealthApiResponseProcessor {
     ...
     */
     public async healthCheckWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        ...
        if (isCodeInRange("400", response.httpStatusCode)) {
            ...
            throw new ApiException<DefaultError>(response.httpStatusCode, "Service error relating to making an embedding or overall service health", body, response.headers);
        }
